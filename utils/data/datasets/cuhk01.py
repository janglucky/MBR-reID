...
from utils.assist import read_json, write_json
...
class CUHK01(ImageDataset):
    ...
    def __init__(self, root='', split_id=0, **kwargs):
        """
        :param root: the path of CUHK01,the structure of the path should like this:
        :param split_id: all the numbers of identifies in CUHK01(971)
